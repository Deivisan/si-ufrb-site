...
export default function Links() {
  const categorias = [
    { nome: 'Sistemas UFRB', links: linksUteis.slice(0, 5), cor: 'bg-ufrb-green' },
    { nome: 'Programação', links: [linksUteis[5]], cor: 'bg-blue-600' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            <Globe className="w-10 h-10 inline mr-2 text-ufrb-green" />
            Links Úteis
          </h1>
        ...
        {categorias.map((categoria, catIndex) => (
          <section key={categoria.nome} className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
              <span className={`w-4 h-4 ${categoria.cor} rounded-full mr-3`}></span>
              {categoria.nome}
            </h2>
              ...
              {categoria.links.map((link, index) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className={`w-14 h-14 ${categoria.cor} rounded-xl flex items-center justify-center text-white flex-shrink-0 group-hover:scale-110 transition-transform`}>
                      {getIcon(link.icon)}
                    </div>
        ...
        <section className="bg-white rounded-2xl shadow-md p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="flex items-start space-x-4">
              <div className="w-12 h-12 bg-ufrb-secondary rounded-full flex items-center justify-center text-white flex-shrink-0">
